<?php
				...
				while($row=$rez->fetch_assoc()){
					...
					$ret.="<a class='tema' href='http://crofiz.com/Tema2.php?id=".$row['id']."' >".$row["ime"]."</a> ";
			...
			function infoKorisnik($id){
				...
				$conn->close();
				return "<a class='nick3' style='font-size: 10px;margin-left:0px;' href='http://crofiz.com/Profil.php?nick=".$row["nick"]."'>".$row["ime"]." ".$row["prezime"]."</a>";
