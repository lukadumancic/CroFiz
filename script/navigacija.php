		...
		<div id="navigacija" class="navigacija">
			<header>
				<div class='crofiz'><a href="http://localhost">CROFIZ</a></div>
			</header>
			<nav>
				<div id="nav" >
			...
			<div id="logReg" >
					...
					<?php 
						...
						';}
							...
							echo "<a href='http://localhost/Profil.php?nick=".$_SESSION["korisnickoIme"]."'>".mojaSlika()."</a><br>";
							echo "<a href='http://localhost/Profil.php?nick=".$_SESSION["korisnickoIme"]."'>".getName($_SESSION["userId"])." ".getSurName($_SESSION["userId"])."</a>";
		...
		$(function(){
		  $('a').each(function() {
			if ($(this).prop('href') == '<?php echo 'http://localhost'.substr($_SERVER['REQUEST_URI'],0,strpos($_SERVER['REQUEST_URI'],".php")+4) ?>') {
